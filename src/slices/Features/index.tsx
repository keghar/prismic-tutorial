  ...
  return (
    <svg
      ...
      <path
        stroke="#0891B2"
        strokeWidth="5"
        d="M6.7 40c0-12.6 0-18.9 3.9-22.8 3.9-3.9 10.2-3.9 22.7-3.9h13.4c12.5 0 18.8 0 22.7 4 4 3.8 4 10.1 4 22.7v6.7c0 12.5 0 18.8-4 22.7-3.9 4-10.2 4-22.7 4H33.3c-12.5 0-18.8 0-22.7-4-4-3.9-4-10.2-4-22.7V40z"></path>
      <path
        stroke="#0891B2"
        strokeLinecap="round"
        strokeOpacity="0.5"
        strokeWidth="5"
        d="M23.3 13.3v-5M56.7 13.3v-5M8.3 30h63.4"></path>
      <path
        fill="#0891B2"
        d="M60 56.7a3.3 3.3 0 11-6.7 0 3.3 3.3 0 016.7 0zM60 43.3a3.3 3.3 0 11-6.7 0 3.3 3.3 0 016.7 0zM43.3 56.7a3.3 3.3 0 11-6.6 0 3.3 3.3 0 016.6 0zM43.3 43.3a3.3 3.3 0 11-6.6 0 3.3 3.3 0 016.6 0zM26.7 56.7a3.3 3.3 0 11-6.7 0 3.3 3.3 0 016.7 0zM26.7 43.3a3.3 3.3 0 11-6.7 0 3.3 3.3 0 016.7 0z"></path>
    </svg>
  );
}
  ...
  return (
    <svg
      ...
      <g stroke="#0891B2" strokeWidth="5" clipPath="url(#clip0_1_1501)">
        ...
        <path
          strokeOpacity="0.5"
          d="M30.1 49.8L40 40l9.9 9.8c9.7 9.6 14.6 14.4 13.2 18.6l-.4 1c-2 4-9 4-22.7 4-13.8 0-20.7 0-22.7-4a7 7 0 01-.4-1c-1.4-4.2 3.5-9 13.2-18.6z"></path>
      </g>
      <defs>
